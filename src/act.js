...
const RENDERING_TEMPLATE = `<phantom-rendering v-for="rendering in chromeData.renderings" :key="rendering.renderTimeStamp" :chrome-data="rendering" ref="renderings"></phantom-rendering>`;
